...
router.delete('/:projectId', projectController.deleteProject); // <-- NUEVA RUTA DE BORRADO
router.post('/:projectId/invitations', projectController.addMember); // <-- RUTA DE INVITACIONES CORREGIDA
